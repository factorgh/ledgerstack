  ...
  return (
    <div className="flex flex-col w-full">
      <PageHeader
        ...
        description="Explore how organizations across food manufacturing, infrastructure engineering, transport logistics, IT, and pharmaceutical healthcare rely on Ledgerstack for software, training, and support."
      />
