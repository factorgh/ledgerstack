...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 text-xs text-amber-800 font-mono font-bold">
                {COMPANY_INFO.tagline}
              </div>
            </div>

            <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-zinc-200 shadow-xs space-y-3">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-zinc-200 shadow-xs space-y-3">
                ...
                <h3 className="text-lg font-bold text-zinc-900">People First</h3>
                <p className="text-xs sm:text-sm text-zinc-600 leading-relaxed font-normal">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-zinc-200 shadow-xs space-y-3">
                ...
                <h3 className="text-lg font-bold text-zinc-900">Reliable Support</h3>
                <p className="text-xs sm:text-sm text-zinc-600 leading-relaxed font-normal">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {coreValues.map((val, i) => (
              <div
                key={i}
                className="p-8 rounded-3xl bg-white border border-zinc-200/90 hover:border-amber-400 hover:shadow-md transition-all space-y-3"
              >
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-xl bg-amber-50 text-amber-800 border border-amber-200 flex items-center justify-center font-mono font-bold text-xs">
                    0{i + 1}
                  </span>
                ...
                <p className="text-sm text-zinc-600 leading-relaxed pl-11 font-normal">
                  {val.desc}
                </p>
              </div>
            ))}
      ...
      {/* CTA Strip */}
      <section className="py-16 bg-zinc-950 text-white border-t border-zinc-900 text-center">
