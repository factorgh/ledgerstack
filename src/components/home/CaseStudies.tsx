        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 sm:gap-6 mb-10 sm:mb-16">
          <div className="space-y-3 sm:space-y-4 max-w-2xl">
            ...
            <p className="text-zinc-600 text-sm sm:text-base lg:text-lg leading-relaxed">
              We partner with organizations across food processing, cloud communications (CPaaS), church management software, IT, and retail healthcare to build resilient operational systems.
            </p>
          </div>
